...
- **Vercel / Netlify:** import repo, framework tự nhận Vite, build command `npm run build`, output `dist`.
- **GitHub Pages:** thêm `base: '/<tên-repo>/'` vào `vite.config.js` rồi deploy thư mục `dist`.
