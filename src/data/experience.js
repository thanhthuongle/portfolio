export const experience = [
  {
    company: {
      vi: 'Công ty cổ phần chứng khoán Phú Hưng (PHS)',
      en: 'Phu Hung Securities Corporation (PHS)',
    },
    role: {
      vi: 'Full Stack Developer Intern',
  ...
  {
    company: {
      vi: 'CÔNG TY CỔ PHẦN CÔNG NGHỆ PIPPIP VIỆT NAM',
      en: 'Pippip Vietnam Technology., JSC',
    },
    role: {
      vi: 'Frontend Developer Intern',
      en: 'Frontend Developer Intern'
    },
    period: '05/2025 — 09/2025',
    description: {
      vi: `Phát triển và bảo trì giao diện người dùng cho Admin Web và Website công ty bằng ReactJS.
      Chuyển đổi thiết kế UI/UX thành các component React responsive và tái sử dụng được.
      Phối hợp với lập trình viên backend để tích hợp API và đảm bảo luồng dữ liệu mượt mà.
      Áp dụng các thực hành tốt nhất về front-end hiện đại trong môi trường sản phẩm thực tế.`,
      en: `Developed and maintained user interfaces for Admin Web and Company Website using ReactJS.
      Translated UI/UX designs into responsive and reusable React components.
      Collaborated with backend developers to integrate APIs and ensure smooth data flow.
      Applied modern front-end best practices in a real-world production environment.`,
    },
